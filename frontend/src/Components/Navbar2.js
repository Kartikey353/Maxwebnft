...
const Navbar2 = () => {
    //   setprofileImage(Mystate.client.data.photoURL
    const Mystate = useSelector((state) => state.loginclickreducer);
    ...
    const getprofiledata = async (e) => {
        ...
        let response = await fetch("http://127.0.0.1:5001/maxnftwebapp/us-central1/app/api/getalluser", {
            method: "GET",
            headers: headersList
        });
            ...
            <div className="hidden md:flex w-full h-full items-center justify-between">
                ...
                <div className="flex items-center gap-8">
                    ...
                    <div onClick={clicking} className="relative">
                        <motion.img whileTap={{
                            scale: 0.6,
                        }} className='w-10 min-w-[40px] h-10 min-h-[40px] shadow-xl rounded-full drop' src={profileImage} alt="" />
                        <div style={{ backgroundColor: 'white' }} className={avtarmenu}>
                            ...
                            <Link to="/accountsetting"><p className="text-black flex  items-center  cursor-pointer hover:bg-slate-100 transition-all ease-in-out duration-100">Account</p></Link>
